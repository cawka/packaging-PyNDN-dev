...
PyObject *
ContentObject_obj_from_ndn_buffer (PyObject *py_buffer)
{
  int r;
  Py_buffer buffer;
  PyObject *py_o;
...
PyObject *
_pyndn_cmd_ContentObject_obj_from_ndn_buffer(PyObject *UNUSED(self), PyObject *py_buffer)
{
	return ContentObject_obj_from_ndn_buffer(py_buffer);
}
