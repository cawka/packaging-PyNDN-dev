#
# This example was written for older version of PyFace and it is currently broken
#

from ndn.Repository import RepoUpload
from pyndn import Face, ContentObject, Name, Key
import struct
...
if __name__ == '__main__':
	...
	def publish(key, name, last_segment, content):
		...
		si.type = ContentObject.ContentType.Face_CONTENT_DATA
