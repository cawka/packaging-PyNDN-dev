...
class Basic(unittest.TestCase):
    ...
    def test_crypto (self):
        ...
        keyLocStr = ndn._ndn.dump_charbuf(keyLoc.ndn_data)
        ...
        capsule = ndn._ndn.new_charbuf('KeyLocator_ndn_data', keyLocStr2)
        keyLoc2 = ndn._ndn.KeyLocator_obj_from_ndn(capsule)
