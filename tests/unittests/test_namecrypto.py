...
import unittest
import ndn
from ndn import Name, NameCrypto, Key, KeyLocator, Face
...
class Basic(unittest.TestCase):
    ...
    def test_crypto (self):
        ...
        # # self.assertEqual (str(auth_name), '')
        ...
        # name_from_js = Name( '/ndn/ucla.edu/apps/cuerda/%40%96%1CQ%00%06cuerdaQk%8A%13%00%07%B8%90%00%00%00%03%00%00%00%00%BB%14%FCHl%A5%F6%5D%18%1EIs%9E%91t%5El%C1y%3F%BAA%A7%02Y%EC%804%23%A4%D4t'
        # )
